...
After [installing Custom Fields version 1.0](/upgrade#2-update-composer-dependencies), to expedite the upgrade process, use the provided Artisan command:
...
- Update the database schema to match version 1.0 requirements.
