...
**Forms:**
- `CustomFieldsComponent` → Removed, use `CustomFields::form()->forModel($record)->build()`
...
**Infolists:**
- `CustomFieldsInfolists` → Removed, use `CustomFields::infolist()->forModel($record)->build()`
